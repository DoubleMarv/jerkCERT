<template>
  ...
  <div class="column is-two-thirds is-mobile certback">
    <div class="thecert" id="maincert" :style="{'background-image': 'url(' + require('./../assets/img/cert-'+ certnum +'.png') + ')'}">
      <img src="./../assets/img/cert-1.png" class="hideo"/> 
        <!-- ////////////////// -->
